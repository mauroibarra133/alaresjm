...
function HeroContactanos() {
  ...
  return (
    <div
      className={`hero-contactanos__container ${clicked ? "active" : ""}`}
      name="#contacto"
      id="contacto"
    >
      ...
      <form
        id={formContactId}
        className="hero-contactanos__form"
      ...
      >
        <div className="hero-contactanos__inputs">
          <div className="hero-contactanos__input">
            ...
            {errors.nombre?.type === "required" && (
              <p role="alert" className="red-error">
                Nombre es requerido
              </p>
            )}
          ...
          <div className="hero-contactanos__input">
            <div>
              ...
              <input
                id={mailId}
                type="email"
                placeholder="Ej: alares@gmail.com"
                {...register("mail", {
                  pattern: EMAIL_REGEX,
                  required: true,
                  minLength: 8,
            ...
            {errors.mail?.type === "pattern" && (
              <p role="alert" className="red-error">
                Debes ingresar un mail valido
              </p>
            )}
            {errors.mail?.type === "minLength" && (
              <p role="alert" className="red-error">
                Debes ingresar mas de 8 caracteres
              </p>
            )}
          </div>
          <div className="hero-contactanos__input">
            <div>
              ...
              <textarea
                name="duda"
                className="hero-contactanos__input-textaerea"
                id={dudaId}
                cols="30"
                rows="10"
                placeholder="Ej: Como contrato el servicio de foodtruck?"
                {...register("descripcion", { required: true, minLength: 10 })}
              ></textarea>
            </div>
            {errors.descripcion?.type === "required" && (
              <p role="alert" className="red-error">
                La duda es requerida
              </p>
            )}
        ...
        <button
          className={`hero-contactanos__button button`}
          type="submit"
          onClick={handleClick}
          disabled={!isValid}
        >
      ...
      {formStatus.isSubmitted && (
        <Modal
          ...
          msg={
            formStatus.goodStatus
              ? "Tu duda y/o inquietud se ha enviado correctamente!"
              : "Tu consulta no ha sido enviada correctamente. Porfavor intente mas tarde."
          }
        />
      )}
