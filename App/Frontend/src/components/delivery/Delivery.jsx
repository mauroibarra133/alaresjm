...
function Delivery() {
  ...
  //Hooks
  const { auth } = useAuth();
  const { cart, clearCart, addToCart, removeProductFromCart, modifyCart } =
    useCart();
  //Use Effects
  useEffect(() => {
    ...
    if (order.tipoPago == "2") {
      ...
      try {
        ...
        const response = await createOrder(
          ...
          parseInt(order.tipoPago),
          parseInt(order.tipoEntrega),
          parseInt(order.montoEft),
          modifyCart(cart)
        );
      ...
      <div className="delivery__container">
        ...
        <div className="order__container">
          ...
          <div className="order__button">
            <button
              className="button delete_cart_button"
              onClick={clearCartDelivery}
            >
          ...
          <Modal
            ...
            msg={
              isOrderedEft.goodStatus
                ...
                : "Tu pedido no pudo ser procesado, intente nuevamente!"
            }
          />
        )}
      </div>
