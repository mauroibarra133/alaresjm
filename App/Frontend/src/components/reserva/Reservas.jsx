...
import {
  ...
  validatePastHour,
  validateTime,
  greaterThanZeroAndNotToBig,
} from "../../utils/functions";

function Reservas() {
  useEffect(() => {
    document.title = "Alares | Reservas ";
  }, []);
  ...
  function handleOpenModal(
    valor,
    msgBad = "Tu reserva no se ha podido confirmar.Intente mas tarde"
  ) {
    setShowModal({
      isSubmitted: true,
      isGood: valor,
      ...
      <div className="reservas__form-wrapper">
        <form className="reservas__form" onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="reservas__row">
            ...
            {errors.hora?.type === "validate" && (
              <p role="alert" className="form-error">
                Debe ser entre las 19:00hs y 23:00hs.
              </p>
            )}
          </div>
          <div className="reservas__row">
            <div>
              ...
              <input
                ...
                {...register("comensales", {
                  required: true,
                  validate: greaterThanZeroAndNotToBig,
                })}
              />
            </div>
            {errors.comensales?.type === "required" && (
              <>
                <p role="alert" className="form-error">
            ...
            {errors.comensales?.type === "validate" && (
              <>
                <p role="alert" className="form-error">
                  {errors.comensales.message}
                </p>
                <p role="alert" className="form-error"></p>
              </>
            )}
          </div>
          <div className="reservas__row">
          ...
          <div className="reservas__row">
            ...
            {errors.cliente?.type === "pattern" && (
              <p role="alert" className="form-error">
                El nombre solo debe incluir letras
              </p>
            )}
          </div>
