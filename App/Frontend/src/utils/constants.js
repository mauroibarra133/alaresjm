...
// Si el origen contiene "localhost", utiliza la URL local, de lo contrario, utiliza la URL de producción
export const SERVER_HOST = origin.includes('localhost') ? 'http://localhost:4000' : 'https://alaresjm.onrender.com';
